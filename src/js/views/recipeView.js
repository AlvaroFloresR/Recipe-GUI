...
class RecipeView extends View {
  ...
  _defaultErrorMsg = "An Error has occured. Recipe not found 😞";
  _defaultMsg = "Start by searching for a recipe or an ingredient. Have fun!";
  ...
  addHandlerServings(handler) {
    this._parentElement.addEventListener("click", function (e) {
      ...
      if (!btn) return;
      const updateTo =
        Number(btn.dataset.updateTo) >= 1 ? Number(btn.dataset.updateTo) : 1;
